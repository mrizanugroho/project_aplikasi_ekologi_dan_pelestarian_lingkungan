...
<body>
<header class="header">
    <h1>Kuis Pilihan Ganda – Pengaruh Manusia terhadap Ekosistem</h1>
...
<div class="modal-overlay" id="resultModal">
  <div class="modal-box">
    ...
    onclick="event.stopImmediatePropagation(); event.preventDefault(); window.location.href='{{ url('/materi3/refleksi') }}';">
    Lanjut ke Refleksi
</button>
    </div>
  </div>
