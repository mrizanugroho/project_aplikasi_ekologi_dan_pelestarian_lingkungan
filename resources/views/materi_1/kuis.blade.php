...
<head>
    ...
    <!-- 🔥 TAMBAHKAN BARIS INI BIAR ROUTE KUIS GAK 404 NYASAR: -->
    <meta name="base-url" content="{{ url('/') }}">
    
    <title>Kuis Ekosistem</title>
    <link rel="stylesheet" href="{{ asset('css/quiz1.css') }}">
    <script defer src="{{ asset('js/quiz1_new.js?v=' . time()) }}"></script>
</head>
<body>
<header class="header">
    <h1>Kuis Pilihan Ganda – Ekosistem</h1>
...
<div class="modal-overlay" id="resultModal">
  <div class="modal-box">
    ...
    <div class="modal-buttons">
      ...
      <button id="btnNextQuiz" class="btn-primary" onclick="window.location.href='{{ url('/materi1/refleksi') }}'">Lanjut ke Refleksi</button>
    </div>
  </div>
</div>
