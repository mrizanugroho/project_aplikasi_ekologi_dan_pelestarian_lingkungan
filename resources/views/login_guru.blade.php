...
<head>
    ...
    <title>Login Guru - Eko-Platform</title>
    ...
    <style>
        ...
        .btn-submit { padding: 12px; border-radius: 8px; border: none; background: #0f6b40; color: white; font-weight: 600; cursor: pointer; transition: 0.3s; }
...
<body>
    ...
    <main class="login-wrapper">
        <div class="login-card">
            <h1>Login Guru</h1>
            <p>Masukkan NIP dan Password akun pendidik.</p>
            
<form action="{{ url('/login') }}" method="POST">
    @csrf
    <input type="text" name="username" placeholder="NIP Akun Guru" required>
