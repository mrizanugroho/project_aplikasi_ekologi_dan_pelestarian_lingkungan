...
<head>
    ...
    <title>Kuis Ekosistem Submateri 4</title>
    <link rel="stylesheet" href="{{ asset('css/quiz1.css') }}">
    <script defer src="{{ asset('js/quiz4.js?v=' . time()) }}"></script>
</head>
<!-- HEADER -->
<header class="header">
    <h1>Kuis Pilihan Ganda – Konservasi</h1>
...
<div class="modal-overlay" id="resultModal">
  <div class="modal-box">
    ...
    onclick="event.stopImmediatePropagation(); event.preventDefault(); window.location.href='{{ url('/materi4/refleksi') }}';">
    Lanjut ke Refleksi
</button>
    </div>
  </div>
